var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "/Content/Metro/" + color + (isRTL ? '-rtl' : '') + ".css");
            $('#logoimg').attr("src", "/Content/img/logo_" + color + ".png");
            $('#rev-hint1').attr("src", "/Content/img/sliders/revolution/hint1-" + color + ".png");
            $('#rev-hint2').attr("src", "/Content/img/sliders/revolution/hint2-" + color + ".png");
        }
